"""Evaluate MeasureByMeasureAnalyzer accuracy"""

import json
from omnitab.tab_ocr.measure_by_measure_analyzer import MeasureByMeasureAnalyzer
...
def evaluate():
    ...
    print("Analyzing with MeasureByMeasureAnalyzer...")
    ...
    print()
    print("=" * 60)
    print("EVALUATION - MeasureByMeasure")
    print("=" * 60)
