"""Evaluate CalibratedAnalyzer accuracy"""

import json
from omnitab.tab_ocr.calibrated_analyzer import CalibratedAnalyzer
...
def evaluate():
    ...
    print("Analyzing with CalibratedAnalyzer...")
    print("Using calibration: S1:10, S2:0, S3:12, S4:10")
    ...
    print()
    print("=" * 60)
    print("EVALUATION - CalibratedAnalyzer")
    print("=" * 60)
    ...
    # Count perfect beats
    perfect = sum(1 for r in beat_results if r["missing"] == 0 and r["extra"] == 0)
    print(f"  Perfect Beats: {perfect}/{len(beat_results)}")
